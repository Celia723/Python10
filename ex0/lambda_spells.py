...
if __name__ == "__main__":
    ...
    artifacts = [{'name': 'Earth Shield', 'power': 67, 'type': 'armor'}, {'name': 'Lightning Rod', 'power': 87, 'type': 'focus'}, {'name': 'Wind Cloak', 'power': 65, 'type': 'armor'}, {'name': 'Shadow Blade', 'power': 62, 'type': 'armor'}]
    mages = [{'name': 'Jordan', 'power': 79, 'element': 'light'}, {'name': 'Jordan', 'power': 87, 'element': 'earth'}, {'name': 'Storm', 'power': 91, 'element': 'shadow'}, {'name': 'Ash', 'power': 84, 'element': 'ice'}, {'name': 'Riley', 'power': 77, 'element': 'earth'}]
